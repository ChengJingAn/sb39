...
import { prePathUrl, returnAudioPath, startRepeatAudio, stopRepeatAudio } from '../components/CommonFunctions';
            ...
            >
                ...
                {[2, 4, 6, 8].map((value, index) =>
                    < BaseImage
                        ...
                        key={index}
                        posInfo={{ l: 0.035, t: 0.065 }}
                        url={"Icons/SB39_Interactive-Icon_SB39_Interactive_Icon_1" + value + ".svg"}
                        geo={_geo}
